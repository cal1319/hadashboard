...
SCHEDULER.every @fetchNewImageEvery, first_in: 0 do
	...
	send_event('tahoe', image: make_web_friendly(@oldFile1))
	sleep(@cameraDelay)
	send_event('tahoe', image: make_web_friendly(new_file1))
end
